...
#define WAKE_BOOTSTRAP_INTERNAL(ArgC, ArgV, Options) Utility::BootstrapOptions WAKE_BOOTSTRAP_OPT_OBJ; \
{Options} \
Utility::Bootstrap WAKE_BOOTSTRAP_OBJ ((ArgC), (ArgV), WAKE_BOOTSTRAP_OPT_OBJ); \
